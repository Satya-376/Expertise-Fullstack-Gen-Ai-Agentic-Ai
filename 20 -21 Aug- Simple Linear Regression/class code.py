...
dataset = pd.read_csv(r'D:\NIT\1. NIT_Batches\1. MORNING BATCH\N_Batch -- 9AM _ Nov26\4. July\1st,2nd - SLR\SIMPLE LINEAR REGRESSION\Salary_Data.csv')
...
# statistic integraton to ml model 
